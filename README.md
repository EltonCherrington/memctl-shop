...
## Buy page
https://cdn.jsdelivr.net/gh/EltonCherrington/memctl-shop@main/site/index.html

Serves via jsDelivr CDN (browser-executable HTML) because the project site's own hosting
domain is filtered upstream. Mirror: product repo https://github.com/EltonCherrington/memctl
...
2. Sum amounts (6 decimals) across the last ~400 blocks.
